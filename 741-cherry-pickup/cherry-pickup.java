class Solution {
    ...
    private int cherryPickup(int[][] grid, int r1, int c1, int r2) {
        ...
        int bothRight = cherryPickup(grid, r1 + 1, c1, r2 + 1); // both in right direction
        int bothDown = cherryPickup(grid, r1, c1 + 1, r2); // both in down direction
        int rightDown = cherryPickup(grid, r1, c1 + 1, r2 + 1); // one right direction and second down direction
        int downRight = cherryPickup(grid, r1 + 1, c1, r2); // one down and second right direction
